...
class OCR:
	def __init__(self,tables,image,i):
		preparePath = 'C:\\Users\\MarijnFerrari\\Documents\\Thesis\\Extraction\\Extraction\\save\\{}\\ocr\\'.format(i)
		#preparePath = 'C:\\Users\\MarijnFerrari\\Documents\\Thesis\\Images\\{}\\'.format(i)

		prepareImages(tables,image,preparePath)

def prepareImages(tables,image,preparePath):
	for i in range(0,len(tables)):
		for j in range(0,len(tables[i])):
			tab = tables[i][j]
			img = image[tab.p1.y:tab.p3.y+1,tab.p1.x:tab.p3.x+1]
